 ...
 *         &lt;element name="information" type="{http://co.dancarlton.com/reservas}ReservasList"/&gt;
 *       &lt;/sequence&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
...
@XmlRootElement(name = "GetReservasResponse")
public class GetReservasResponse {

    @XmlElement(required = true)
    protected Header header;
    @XmlElement(required = true)
    protected ReservasList information;
     ...
     *     
     */
    public ReservasList getInformation() {
        return information;
    }
     ...
     *     
     */
    public void setInformation(ReservasList value) {
