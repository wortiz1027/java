...
# -              contenedor con el reservas de habitaciones
# ---------------------------------------------------------------------
...
LABEL org.opencontainers.image.created=$BUILD_DATE \
	  ...
	  org.opencontainers.image.title="Reservas Hotel Dan Carlton" \
	  org.opencontainers.image.description="El siguiente servicio tiene como finalidad gestionar habitaciones del hotel dan carlton"
...
COPY --from=BUILDER /build/target/dancarlton-service.jar ${APP_HOME}

ENTRYPOINT ["java","-jar","/app/dancarlton-service.jar"]