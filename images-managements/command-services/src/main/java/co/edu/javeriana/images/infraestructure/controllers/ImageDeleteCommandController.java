...
@Api(value="Eliminacion de imagenes que han sido registradas en toures balon")
public class ImageDeleteCommandController {

    private final ImagesCommandService service;

    @ApiOperation(value = "Eliminacion de imagenes en el sistema", response = Response.class)
    @ApiResponses(value = {
            @ApiResponse(code = 200, message = "Eliminacion exitosa de la imagen"),
