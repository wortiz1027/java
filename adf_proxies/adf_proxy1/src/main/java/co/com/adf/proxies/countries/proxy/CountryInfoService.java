 ...
 *
 */
@WebServiceClient(name = "CountryInfoService", targetNamespace = "http://www.oorsprong.org/websamples.countryinfo",
                  wsdlLocation =
                  "http://webservices.oorsprong.org/websamples.countryinfo/CountryInfoService.wso?WSDL#%7Bhttp%3A%2F%2Fwww.oorsprong.org%2Fwebsamples.countryinfo%7DCountryInfoService")
@HandlerChain(file="CountryInfoServiceProxy-HandlerChain.xml")
public class CountryInfoService extends Service {
    ...
    private final static QName COUNTRYINFOSERVICE_QNAME =
        new QName("http://www.oorsprong.org/websamples.countryinfo", "CountryInfoService");
    ...
    static {
        ...
        try {
            url =
                new URL("http://webservices.oorsprong.org/websamples.countryinfo/CountryInfoService.wso?WSDL#%7Bhttp%3A%2F%2Fwww.oorsprong.org%2Fwebsamples.countryinfo%7DCountryInfoService");
    ...
    public CountryInfoServiceSoapType getCountryInfoServiceSoap() {
        return super.getPort(new QName("http://www.oorsprong.org/websamples.countryinfo", "CountryInfoServiceSoap"),
                             CountryInfoServiceSoapType.class);
    }
    ...
    public CountryInfoServiceSoapType getCountryInfoServiceSoap(WebServiceFeature... features) {
        return super.getPort(new QName("http://www.oorsprong.org/websamples.countryinfo", "CountryInfoServiceSoap"),
                             CountryInfoServiceSoapType.class, features);
    }
    ...
    public CountryInfoServiceSoapType getCountryInfoServiceSoap12() {
        return super.getPort(new QName("http://www.oorsprong.org/websamples.countryinfo", "CountryInfoServiceSoap12"),
                             CountryInfoServiceSoapType.class);
    }
