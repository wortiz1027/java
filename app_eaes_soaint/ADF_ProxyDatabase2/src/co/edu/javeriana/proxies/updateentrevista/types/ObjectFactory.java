...
package co.edu.javeriana.proxies.updateentrevista.types;
 ...
 * generated in the co.edu.javeriana.proxies.updateentrevista.types package.
...
public class ObjectFactory {
    ...
    private final static QName _Request_QNAME =
        new QName("http://xmlns.javeriana.edu.co/co/schemas/process/bpm/ActualizarObsEntrevista/v1.0", "request");
    private final static QName _Response_QNAME =
        new QName("http://xmlns.javeriana.edu.co/co/schemas/process/bpm/ActualizarObsEntrevista/v1.0", "response");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: co.edu.javeriana.proxies.updateentrevista.types
     *
     */
     ...
     */
    @XmlElementDecl(namespace = "http://xmlns.javeriana.edu.co/co/schemas/process/bpm/ActualizarObsEntrevista/v1.0",
                    name = "request")
